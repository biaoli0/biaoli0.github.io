  ...
  const projects = [
    {
      ...
      raw data and create visualizations, which reduced visualization production time from weeks to hours`,
      responsibilities: [
    ...
    },
    {
      ...
      description: `Introduced type package to be shared across monorepo to support tighter 
